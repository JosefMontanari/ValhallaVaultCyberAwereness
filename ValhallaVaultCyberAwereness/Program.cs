...
using ValhallaVaultCyberAwereness.Data.JosefsMiddleware;
...
//var connectionString = KeyManager.GetConnectionString().GetAwaiter().GetResult();
...
// Aktivera Josefs middle ware
app.UseMiddleware<IpAdressMiddleWare>();
